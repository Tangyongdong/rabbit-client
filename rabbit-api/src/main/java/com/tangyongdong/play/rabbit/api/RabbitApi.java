package com.tangyongdong.play.rabbit.api;

import com.tangyongdong.base.common.response.CommonResponse;
import com.tangyongdong.play.rabbit.api.fallback.RabbitApiFallback;
 ...
 */
@FeignClient(value = "rabbit-client", fallbackFactory = RabbitApiFallback.class)
